...
function beforeCopyExtraFiles(_x, _x2, _x3, _x4) {
  return _beforeCopyExtraFiles.apply(this, arguments);
}

function _beforeCopyExtraFiles() {
  _beforeCopyExtraFiles = (0, _bluebirdLst().coroutine)(function* (packager, appOutDir, asarIntegrity, isClearExecStack) {
...
function createElectronFrameworkSupport(_x5, _x6) {
