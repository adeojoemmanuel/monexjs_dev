...
class WinPackager extends _platformPackager().PlatformPackager {
  constructor(info) {
    ...
    this.computedPublisherSubjectOnWindowsOnly = new (_lazyVal().Lazy)(
    /*#__PURE__*/
...
function extractCommonNameUsingOpenssl(_x, _x2) {
  return _extractCommonNameUsingOpenssl.apply(this, arguments);
} function _extractCommonNameUsingOpenssl() {
  _extractCommonNameUsingOpenssl = (0, _bluebirdLst().coroutine)(function* (password, certPath) {
